    ...
    <Sonner
      ...
      toastOptions={{
        classNames: {
          ...
          success:
            "group toast group-[.toaster]:bg-green-700 group-[.toaster]:text-white group-[.toaster]:border-green-600 group-[.toaster]:shadow-lg dark:group-[.toaster]:bg-green-500 dark:group-[.toaster]:border-green-700",
        },
      }}
      {...props}
    />
